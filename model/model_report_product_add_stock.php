...
while ($rowStock = $listStock->fetch()) {
    if ($listStock->rowCount() > 0 && $i == 0) {
        echo "<table border='1' id='the-table' class='table table-hover table-light table-bordered'><thead class='thead-dark'><tr><th  class='text-center align-middle'>รหัสสินค้า</th><th class='align-middle text-center'>ชื่อสินค้า</th><th  class='text-center align-middle'>จำนวนที่นำเข้า</th></tr></thead><tbody>";
    }
    echo '<tr>
